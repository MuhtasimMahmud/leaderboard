...
class AppTextStyle {
  ...
  static TextStyle get textStyle14Bold => const TextStyle(
      fontWeight: FontWeight.bold, fontSize: AppFontSizes.font14);

  static TextStyle get textStyle10Regular => const TextStyle(
      fontWeight: FontWeight.normal, fontSize: AppFontSizes.xSmallTextSize);

  static TextStyle get textStyle12Bold => const TextStyle(
      fontWeight: FontWeight.bold, fontSize: AppFontSizes.font12);

  static TextStyle get normalBlackTextStyle_14 => TextStyle(
      color: ColorUtil.grayColor, fontWeight: FontWeight.w500, fontSize: 14);
}
